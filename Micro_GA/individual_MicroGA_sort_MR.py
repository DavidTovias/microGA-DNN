...
import numpy as np
import copy
from obj_fun.obj_fun import objFun, get_index_MR
from abstract.abs_individuals import IIndividual

class IndividualMicroGA_SORT_MR(IIndividual):
    ...
    def evaluate(self, data):
        ...
        if not "index_MR" in self.params:
            self.params.update({"index_MR" : get_index_MR(None, None).tolist()})
